# DeHax V2.2.5 — correção do checkout travado
...
## O que mudou
- cache bust `?v=2.2.5` nos assets locais das páginas;
...
## Atualização
Substitua a V2.2.3 pela V2.2.5 na branch `teste` e faça um commit. Não execute SQL e não altere credenciais.
