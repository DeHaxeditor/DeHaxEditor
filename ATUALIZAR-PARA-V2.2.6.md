...
Na V2.2.9, o cabeçalho `Authorization` só é enviado quando realmente existe um access token. Usuários convidados continuam autenticando o pagamento pelo `checkoutToken` temporário criado pelo checkout.

## Como atualizar

Substitua a V2.2.5 pela V2.2.9 na branch `teste` e aguarde o Branch Deploy.
