...
const required=[
  ...
  'services/vod-worker/Dockerfile','services/vod-worker/requirements.txt','supabase/schema.sql','supabase/migration-v2.2.1.sql','supabase/migration-v2.2.2.sql','supabase/migration-v2.3.0.sql','netlify/functions/checkout-session.mjs','docs/R2-CORS.json','docs/R2-MEDIA-CORS.json','docs/SUPABASE-CONFIRMACAO-CODIGO.html','CONFIGURAR-EMAIL-RESEND.md'
];
let bad=false;
...
console.log('DeHax V2.3.0 checks passed.');
